  ...
  return (
    <div className="bg-container">
      ...
      <Container id="Home" className="home-bg-container" fluid>
                <Row>
                    <Col lg={6} xs={12} style={{ display: "flex", alignItems: "center", justifyContent: "center" }} >
                    ...
                    <Col className="image-column" lg={6} xs={12} style={{ display: "flex", justifyContent: "center" }} >
            ...
            <Container id="About" className="about-section" fluid>
                <Row>
                    ...
                    <Col className="image-column" lg={6}  xs={12} style={{ display: "flex", justifyContent:"center" ,alignItems: "center" }}>
                        <img src={aboutImage} className="aboutImg" alt="whyUsImage" />
                    </Col>
                    <Col className="content-sec" lg={6}  xs={12} style={{ display: "flex",flexDirection:"column", justifyContent: "center" }} >
            ...
            <Container className="more-details" fluid>
                       <Row style={{display:"flex",justifyContent:"center"}}>
                            <Col style={{display: "flex", justifyContent:"center" ,alignItems: "center"  }} xs={12} lg={5} >
                    ...
                    <Container  id="Courses" className="course-details" fluid xs={12} md={12}>
                    <Row style={{margin:"0px"}} className="course-details">
                        <h1 className="common-heading text-center m-3">Courses We Offer</h1>
                        <Col className="image-column d-lg-none " lg={6} xs={12} md={12} style={{ display: "flex", justifyContent: "center" }}>
                            <img src={guitar} className="guitarImg" alt="guitarImage" />
                        </Col>
                        <Col className="content-sec" lg={6}  xs={12}>
                        <h1 className="common-heading">
                        ...
                        <Col className="image-column d-none d-lg-block" lg={6}  xs={12} style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                ...
                <Container className="course-details" fluid xs={12}>
                    <Row>
                        <Col className="image-column d-lg-none" lg={6}  xs={12} style={{ display: "flex", justifyContent: "center" }}>
                    ...
                    <Row className="footer-section pt-5 pb-5">
                        <Col lg={4}  sm={12} xs={12}>
                            ...
                            <p className="description">
                                ...
                                <div>
                                <FontAwesomeIcon class="social-icon" icon={faLinkedin} />
                                </div>
                            </div>
                        </Col>
                        <Col lg={4} xs={12} className="contact-details">
                            <h1 className="common-heading" style={{ fontSize: "35px" }}>
                            Contact Us
                            </h1>
                            ...
                            <div className="contactIcon-detail-container">
                                ...
                                <p className="contact-description">7416852057</p>
                            </div>
                            <div className="contactIcon-detail-container">
                                <FontAwesomeIcon
